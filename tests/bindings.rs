...
/// If bindgen is installed, run it to check that the NFS bindings in the OS
/// haven't changed.  It's important to run this test on FreeBSD current every
/// so often, but that's difficult to do in Github Workflows.
#[test]
fn stable_bindings() {
